...
class CNNEncoder(torch.nn.Module):
    def __init__(self, feature_dim_s16, feature_dim_s8):
        ...
        self.block_8_1 = ConvBlock(3, feature_dim_s8, kernel_size=8, stride=4, padding=2)
        ...
        # self.block_16_1 = ConvBlock(3, feature_dim_s8, kernel_size=8, stride=4, padding=2)
        self.block_16_1 = ConvBlock(3, feature_dim_s8, kernel_size=6, stride=2, padding=2)

        self.block_8_16 = ConvBlock(feature_dim_s8, feature_dim_s8, kernel_size=6, stride=2, padding=2)

        self.block_cat_16 = ConvBlock(feature_dim_s8 * 2, feature_dim_s16 - 2, kernel_size=3, stride=1, padding=1)
